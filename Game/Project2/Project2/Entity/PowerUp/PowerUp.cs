...
namespace Project2.Entity
{
    ...
    class PowerUp:Entity
    {
        ...
        float lifeTime = 0.0f;
        const float TOTALDURATION = 20.0f;
        powerType type;
            ...
            : base(game)
        {
            ...
            addComponent(new Collidable(game, this, CollisionType.powerUp, onHit, 1, 0,getComponent<Drawable3D>().modelBoundingBox));
            this.type = type;
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (lifeTime > TOTALDURATION && type == powerType.ring)
            {
