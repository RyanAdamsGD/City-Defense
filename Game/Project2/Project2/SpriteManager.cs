...
namespace Project2
{
    ...
    public class SpriteManager : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(scoreDisplay, altitude, new Vector2(screenWidth - 200, screenHeight / 2), Color.Lime);
            spriteBatch.DrawString(scoreDisplay, Speed, new Vector2(50, screenHeight / 2), Color.Lime);
            ...
            spriteBatch.Draw(sight, new Rectangle((screenWidth - sight.Width) / 2, 60, sight.Width, sight.Height), retical);
            ...
            if (((Game1)Game).getBulletCount() > 0)
            {
                ...
                spriteBatch.DrawString(scoreDisplay, bulletCount, new Vector2(screenWidth - 200, (screenHeight / 2) + 350), Color.Lime);
            }
            if (((Game1)Game).getMissileCount() > 0)
            {
                ...
                spriteBatch.DrawString(scoreDisplay, missileCount, new Vector2(screenWidth - 200, (screenHeight / 2) + 450), Color.Lime);
            }
            ...
            if (((Game1)Game).getBulletCount() <= 0)
            {
                ...
                spriteBatch.DrawString(scoreDisplay, bulletCount, new Vector2(screenWidth - 200, (screenHeight / 2) + 350), Color.Red);
            }
            if (((Game1)Game).getMissileCount() <= 0)
            {
                ...
                spriteBatch.DrawString(scoreDisplay, missileCount, new Vector2(screenWidth - 200, (screenHeight / 2) + 450), Color.Red);
            }
            drawHealthBar();
            spriteBatch.End();
            base.Draw(gameTime);
