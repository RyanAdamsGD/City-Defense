...
namespace Project2
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        Player player;
        Vector3 spawnPoint = new Vector3(0, 2000, 0);
        ...
        {
            //new BasicModel(this, Content.Load<Model>(@"Models\Canyon\Canyon1"), Matrix.CreateScale(100));
            //new BasicModel(this, Content.Load<Model>(@"Models\Canyon\Canyon2"), Matrix.CreateScale(100));
            //new BasicModel(this, Content.Load<Model>(@"Models\Canyon\Canyon3"), Matrix.CreateScale(100));
            //new BasicModel(this, Content.Load<Model>(@"Models\Canyon\Canyon4"), Matrix.CreateScale(100));
            //new BasicModel(this, Content.Load<Model>(@"Models\Canyon\Canyon5"), Matrix.CreateScale(100));
        }
        ...
        public void addAnEnemy()
        {
            ...
            new Enemy(this, spawnPoint, player);
        }
        ...
        public void changeScreenWidth()
        {
            if (Window.ClientBounds.Width == 1600)
            {
                graphics.PreferredBackBufferWidth = 1900;
            }
            else if (Window.ClientBounds.Width == 1900)
            {
                graphics.PreferredBackBufferWidth = 1600;
            }
